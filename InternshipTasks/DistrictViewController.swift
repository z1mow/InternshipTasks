...
class DistrictViewController: UIViewController, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    private func loadDistricts() {
        districts = getDistrictsForCity(selectedCity ?? "")
        filteredDistricts = districts.sorted()
    }
    
    private func getDistrictsForCity(_ city: String) -> [String] {
        let districtDict: [String: [String]] = [
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = filteredDistricts[indexPath.row]
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let pharmacyVC = storyboard.instantiateViewController(withIdentifier: "PharmacyListViewController") as? PharmacyListViewController {
            pharmacyVC.selectedCity = selectedCity
            pharmacyVC.selectedDistrict = selectedDistrict
            pharmacyVC.modalPresentationStyle = .fullScreen
            present(pharmacyVC, animated: true)
        }
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        if searchText.isEmpty {
            ...
            filteredDistricts = districts.filter { $0.lowercased().contains(searchText.lowercased()) }.sorted()
        }
